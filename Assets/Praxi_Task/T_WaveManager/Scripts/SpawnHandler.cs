...
public class SpawnHandler : MonoBehaviour
{
    ...
    {
        StartCoroutine(SpawnWaveCoroutine(wavesData, currentWaveData, spawnPoints, enemyParent, groupRadius));
    }

    private IEnumerator SpawnWaveCoroutine(StageWaves wavesData, WaveData currentWaveData, List<Transform> spawnPoints, Transform enemyParent, float groupRadius)
    {
        MeleeEnemy.Clear();
        RangedEnemy.Clear();
